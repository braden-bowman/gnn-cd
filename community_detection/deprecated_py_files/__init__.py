...
from .data_prep import (
    ...
    convert_nx_to_pytorch_geometric, plot_graph, generate_synthetic_graph,
...
from .gnn_community_detection import (
    nx_to_pyg, GCN, GraphSAGE, GAT, VGAE,
...
from .overlapping_community_detection import (
    ...
    run_bigclam, run_demon, run_slpa, GNN_Overlapping, nx_to_pyg_overlapping,
